...
public class EnglishQuizActivity extends AppCompatActivity {
    ...
    int score=0;
    int totalQuestion = EnglishQuestion.question.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quitTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(EnglishQuizActivity.this,DashBoardActivity.class));
                finish();
            }
        });
    ...
    private void loadNewQuestion() {
        ...
        questionTextView.setText(EnglishQuestion.question[currentQuestionIndex]);
        ansA.setText(EnglishQuestion.choices[currentQuestionIndex][0]);
        ansB.setText(EnglishQuestion.choices[currentQuestionIndex][1]);
        ansC.setText(EnglishQuestion.choices[currentQuestionIndex][2]);
        ansD.setText(EnglishQuestion.choices[currentQuestionIndex][3]);
    ...
    private void onClick(View view){
        ...
        if(clickedButton.getId() == R.id.btn_submit) {
            if(!selectedAnswer.isEmpty()){
                if(selectedAnswer.equals(EnglishQuestion.correctAnswers[currentQuestionIndex])){
                    score++;
                }else{
