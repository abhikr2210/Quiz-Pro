...
public class ChemistryQuizActivity extends AppCompatActivity {
    ...
    int score=0;
    int totalQuestion = ChemistryQuestion.question.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quitTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(ChemistryQuizActivity.this,DashBoardActivity.class));
                finish();
            }
        });
    ...
    private void loadNewQuestion() {
        ...
        questionTextView.setText(ChemistryQuestion.question[currentQuestionIndex]);
        ansA.setText(ChemistryQuestion.choices[currentQuestionIndex][0]);
        ansB.setText(ChemistryQuestion.choices[currentQuestionIndex][1]);
        ansC.setText(ChemistryQuestion.choices[currentQuestionIndex][2]);
        ansD.setText(ChemistryQuestion.choices[currentQuestionIndex][3]);
    ...
    private void onClick(View view){
        ...
        if(clickedButton.getId() == R.id.btn_submit) {
            if(!selectedAnswer.isEmpty()){
                if(selectedAnswer.equals(ChemistryQuestion.correctAnswers[currentQuestionIndex])){
                    score++;
                }else{
