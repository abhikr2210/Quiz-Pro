...
public class MathsQuizActivity extends AppCompatActivity {
    ...
    int score=0;
    int totalQuestion = MathsQuestion.question.length;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quitTextView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(MathsQuizActivity.this,DashBoardActivity.class));
                finish();
            }
        });
    ...
    private void loadNewQuestion() {
        ...
        questionTextView.setText(MathsQuestion.question[currentQuestionIndex]);
        ansA.setText(MathsQuestion.choices[currentQuestionIndex][0]);
        ansB.setText(MathsQuestion.choices[currentQuestionIndex][1]);
        ansC.setText(MathsQuestion.choices[currentQuestionIndex][2]);
        ansD.setText(MathsQuestion.choices[currentQuestionIndex][3]);
    ...
    private void onClick(View view){
        ...
        if(clickedButton.getId() == R.id.btn_submit) {
            if(!selectedAnswer.isEmpty()){
                if(selectedAnswer.equals(MathsQuestion.correctAnswers[currentQuestionIndex])){
                    score++;
                }else{
